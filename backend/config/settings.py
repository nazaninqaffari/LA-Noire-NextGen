"""
Django settings for LA Noire NextGen project.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='lanoire_db'),
...
# Custom authentication backend — allows login via username, email,
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'LA Noire NextGen Police Management API',
    'DESCRIPTION': 'A comprehensive police management system inspired by LA Noire',
    'VERSION': '1.0.0',
